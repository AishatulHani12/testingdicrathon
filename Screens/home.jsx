...
export class Home extends Component {
  render() {
    return (
      <View className="flex-1 items-center justify-start py-10 ml-10">
      <ScrollView className="-mx-20 pl-46" >
        <View className="w-80 h-16 bg-emerald-700 rounded-lg ml-7">
        ...
        <View className="w-screen">
          <Image className="w-full h-52 rounded-sm  " resizeMode="contain" source={require("../assets/image1.png")} ></Image>
        </View>
        <View className="ml-5">
        ...
        <View className="top-7 ml-5">
          <Text className=" text-left text-2xl font-extrabold">Review</Text>
        </View>
        <View className="flex-row ">
          <Image className="w-10 h-10 left-5 top-10 rounded-full" source={require("../assets/penguindp.jpeg")} ></Image>
        </View>
        ...
        <View className="flex-row justify-end ">
          <Image className="w-60 h-50 right-6 -top-4 rounded-lg" source={require("../assets/penguindp.jpeg")} ></Image>
        </View>
      </ScrollView>
    </View>
    )
